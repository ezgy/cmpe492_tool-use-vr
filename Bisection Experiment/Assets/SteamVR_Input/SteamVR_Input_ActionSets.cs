...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_bisectionInput p_bisectionInput;
        ...
        public static SteamVR_Input_ActionSet_bisectionInput bisectionInput
        {
            get
            {
                return SteamVR_Actions.p_bisectionInput.GetCopy<SteamVR_Input_ActionSet_bisectionInput>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_bisectionInput = ((SteamVR_Input_ActionSet_bisectionInput)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_bisectionInput>("/actions/bisectionInput")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.bisectionInput};
        }
    }
}
